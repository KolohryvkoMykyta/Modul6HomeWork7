...
namespace Catalog.Host.Migrations
{
    ...
    [Migration("20230816222140_Initial-Create")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.HasSequence("catalog_radius_hilo")
                .IncrementsBy(10);
            ...
            modelBuilder.Entity("Catalog.Host.Data.Entities.CatalogItem", b =>
                {
                    ...
                    b.Property<int>("CatalogRadiusId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Catalog.Host.Data.Entities.CatalogRadius", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseHiLo(b.Property<int>("Id"), "catalog_radius_hilo");
                    ...
                    b.ToTable("CatalogRadius", (string)null);
                });
            ...
            modelBuilder.Entity("Catalog.Host.Data.Entities.CatalogItem", b =>
                {
                    ...
                    b.HasOne("Catalog.Host.Data.Entities.CatalogRadius", "CatalogRadius")
                        .WithMany()
                        .HasForeignKey("CatalogRadiusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
