        ...
        Flows = new OpenApiOAuthFlows()
        {
            Implicit = new OpenApiOAuthFlow()
            {
                ...
                Scopes = new Dictionary<string, string>()
                {
                    ...
                    { "catalog.catalogradius", "catalog.catalogradius" }
                }
            }
        }
    });
...
builder.Services.AddTransient<ICatalogRadiusRepository, CatalogRadiusRepository>();
...
builder.Services.AddTransient<ICatalogRadiusService, CatalogRadiusService>();
